...
class SignOutScreen22 extends StatefulWidget {
  @override
  State<SignOutScreen22> createState() => _SignOutScreen22State();
}


class _SignOutScreen22State extends State<SignOutScreen22> {
  ...
  Future<void> _signOut(BuildContext context) async {
    ...
    try {
      ...
      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> LoginScreenq(phoneNumber: '', password2: '')));
                  ...
                  builder: (context) {
                    return Column(
                      ...
                      children: [
                        ...
                        Divider(),
                        InkWell(
                          onTap: () => navigateToDarkModeScreen(context),
                          child: ListTile(
